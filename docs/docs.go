...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handler.ListChatsResponse"
                            }
                        }
                    },
                    "500": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.GetChatMessagesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.PongResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found"
    ...
    "definitions": {
        ...
        "handler.GetChatMessagesResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
